...
public class SearchServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        int countP = pdao.countSearchProduct(cid, key, fromprice, toprice, fromdate, todate);
        int endpage = countP / 10;
        if (countP % 10 != 0) {
            endpage++;
        }
        List<Category> listC = pdao.getAllCategory();
        List<Product> listP = pdao.search(cid, key, fromprice, toprice, fromdate, todate, sort, index);
