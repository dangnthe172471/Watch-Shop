...
Với sự kết hợp hoàn hảo giữa tính năng và kiểu dáng, Rolex Cosmograph Daytona không chỉ là một chiếc đồng hồ mà còn là biểu tượng của sự thành công và đẳng cấp.', 4.8, 1,3,6, 1),

(N'R-L-002',N'Rolex YACHT-MASTER 42', 3650, 1500, 1200, CAST(N'2023-12-12' AS Date), N'Rolex Yacht-Master 42 là một trong những phiên bản đặc biệt của dòng Yacht-Master của Rolex, nổi tiếng với sự kết hợp hoàn hảo giữa tính năng thể thao và phong cách sang trọng. Với kích thước lớn hơn so với các phiên bản trước đó, chiếc đồng hồ này mang lại sự ấn tượng mạnh mẽ trên cổ tay và đồng thời tôn lên vẻ đẳng cấp và quý phái.<br><br>
...
Với bộ máy cơ tự động Rolex calibre 3235, Yacht-Master 42 không chỉ đảm bảo độ chính xác cao mà còn có khả năng chống nước đến độ sâu 100 mét (330 feet), phù hợp cho các hoạt động trên biển. Chiếc đồng hồ này không chỉ là một phụ kiện thể thao mà còn là biểu tượng của sự hiện đại và đẳng cấp trong thế giới đồng hồ cao cấp.',4.7, 1,4,7,2),

(N'C-T-001',N'Đồng Hồ Santos de Carter WSSA0061', 3500, 1500, 800, CAST(N'2023-03-19' AS Date), N'Đồng hồ Santos de Cartier WSSA0061 là một biểu tượng của sự tinh tế và đẳng cấp từ nhà sản xuất đồng hồ danh tiếng Cartier. Thiết kế của nó lấy cảm hứng từ phiên bản ban đầu được sáng tạo bởi Louis Cartier cho người bạn thân của mình, Alberto Santos-Dumont, một nhà hàng không nổi tiếng.<br><br>
...
(N'R-L-003',N'Rolex 1908', 3700, 700, 2000, CAST(N'2024-01-30' AS Date), N'Rolex 1908 là một trong những mảnh ghép quan trọng trong hành trình phát triển của hãng đồng hồ danh tiếng này. Năm 1908, Rolex đã đặt nền móng cho sự nghiên cứu và phát triển về độ chính xác và độ bền bỉ của các thiết bị đo thời gian, tạo ra những tiêu chuẩn mới trong ngành công nghiệp đồng hồ. Sự cam kết này đã điểm đặc biệt cho Rolex và làm nên tên tuổi của họ trong thế giới đồng hồ cao cấp. <br><br>
Từ khi thành lập, Rolex đã không ngừng tiến xa hơn trong việc phát triển và cải tiến công nghệ đồng hồ, từ việc chế tạo ra những bộ máy cơ chính xác đến việc thiết kế các thiết kế vỏ độc đáo và tinh tế. Rolex 1908 đóng vai trò là cột mốc quan trọng trong hành trình không ngừng của hãng để đem lại những chiếc đồng hồ tinh tế và đáng tin cậy nhất cho người đeo trên toàn thế giới.',4.6, 1,5,6,4),

(N'P-T-001',N'Đồng hồ Patek Philippe Nautilus', 3880, 800, 500, CAST(N'2023-08-15' AS Date), N'Đồng hồ Patek Philippe Nautilus là một biểu tượng của sự tinh tế và sang trọng từ thương hiệu đồng hồ xa xỉ Patek Philippe. Được giới thiệu lần đầu vào năm 1976, Nautilus nhanh chóng trở thành một trong những mẫu đồng hồ thể thao cao cấp được ưa chuộng nhất trên thị trường.<br><br>
...
Với sự kết hợp hoàn hảo giữa kiểu dáng tinh tế và tính năng cao cấp, đồng hồ Cartier Santos WSSA0030 là một lựa chọn lý tưởng cho những người đam mê đồng hồ cao cấp và đẳng cấp.',4.7, 2,4,7,3),

(N'P-T-002',N'Đồng hồ Patek Philippe Complications', 3150, 800, 600, CAST(N'2023-05-21' AS Date), N'Đồng hồ Patek Philippe Complications User là một biểu tượng của sự tinh tế và tinh thần sáng tạo từ nhà sản xuất đồng hồ xa xỉ Patek Philippe. Với dòng sản phẩm Complications, Patek Philippe không chỉ mang đến sự đẳng cấp mà còn thể hiện sự phức tạp và khả năng sáng tạo trong thiết kế và công nghệ đồng hồ.<br><br>
...
(N'A-P-003',N'Đồng Hồ AP Royal Oak Concept Flying Tourbillon', 3550, 2000, 1250, CAST(N'2024-01-12' AS Date), N'Đồng Hồ AP Royal Oak Concept Flying Tourbillon là một biểu tượng của sự sáng tạo và đẳng cấp từ thương hiệu đồng hồ cao cấp Audemars Piguet. Royal Oak Concept là dòng sản phẩm độc đáo, thường được biết đến với các tính năng và công nghệ tiên tiến.<br><br>
...
Với sự kết hợp hoàn hảo giữa công nghệ và thiết kế đột phá, đồng hồ AP Royal Oak Concept Flying Tourbillon là một lựa chọn lý tưởng cho những người yêu thích đồng hồ cao cấp và đam mê sự đổi mới.',4.8, 2,3,8,2),

(N'C-T-003',N'Đồng Hồ Cartier Santos W2SA0007', 3850, 1500, 1500, CAST(N'2023-05-30' AS Date), N'Đồng Hồ Cartier Santos W2SA0007 là một biểu tượng của sự tinh tế và sang trọng từ thương hiệu đồng hồ danh tiếng Cartier. Santos là một trong những dòng sản phẩm đáng chú ý nhất của Cartier, với thiết kế độc đáo và lịch lãm.<br><br>
