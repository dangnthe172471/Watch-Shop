...
(3, CAST(N'2020-06-12' AS Date), CAST(N'2020-06-14' AS Date), N'20:00', CAST(N'2020-06-14' AS Date), 64000000, N'user1@gmail.com', N'0123456789', N'Ha Noi', 3),
(3, CAST(N'2021-05-05' AS Date), CAST(N'2021-05-07' AS Date), N'08:00', CAST(N'2020-06-14' AS Date), 90000000, N'user1@gmail.com', N'0123456789', N'Hai phong',3),
(4, CAST(N'2021-10-12' AS Date), CAST(N'2021-10-15' AS Date), N'21:00', CAST(N'2020-06-14' AS Date), 32000000, N'user2@gmail.com', N'0123456789', N'Hue',3),
(4, CAST(N'2021-12-12' AS Date), CAST(N'2020-06-14' AS Date), N'10:00', CAST(N'2021-12-12' AS Date), 90000000, N'user2@gmail.com', N'0123456789', N'Bac Giang',3),
(3, CAST(N'2022-01-05' AS Date), CAST(N'2020-06-14' AS Date), N'12:00', CAST(N'2022-01-08' AS Date), 62000000, N'user1@gmail.com', N'0123456789', N'Hai Duong',3),
(4, CAST(N'2022-03-12' AS Date), CAST(N'2020-06-14' AS Date), N'23:00', CAST(N'2022-03-12' AS Date), 64000000, N'user2@gmail.com', N'0123456789', N'Bac Ninh',3),
(4, CAST(N'2022-08-05' AS Date), CAST(N'2020-06-14' AS Date), N'19:00', CAST(N'2022-08-08' AS Date), 60000000, N'user2@gmail.com', N'0123456789', N'Ninh Binh',2),
